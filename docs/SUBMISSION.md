...
待创建公开仓库：`https://github.com/hnaymyh123-henry/ProofMesh`
...
提交前必须把 Sites 访问模式从 `custom` 改为 `public`，确保评委无需登录即可体验。
...
待公开 GitHub 后填写：  
`https://github.com/hnaymyh123-henry/ProofMesh/raw/refs/heads/main/output/playwright/ProofMesh-Demo-EN.mp4`
...
- [ ] Sites Demo 已改为 public，并用无登录环境验证
- [ ] 视频公开链接可在线播放或下载
- [ ] 参赛者本人确认授权条款
- [ ] 在飞书表单点击最终“提交”
